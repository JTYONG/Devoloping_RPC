...
'''
# Canvas
c = ROOT.TCanvas("c_signal", "Ion Signal", 900, 600)
c.SetGrid()
...
g_ion.SetTitle("Induced Current; Time[ns];Current [fC/ns].")
g_ion.Draw("APL")
...
ROOT.gPad.Update()
c.SaveAs("induced_ion_signal.png")
print("Saved induced_ion_signal.png")
